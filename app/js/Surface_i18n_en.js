if (typeof _registerTranslations === "function") {
    _registerTranslations("en", {
        ...
        "conn.intro": "External sources importing fleet-wide vulnerabilities. A finding the source stops reporting is closed automatically in Surface.",
        "conn.none_installed": "No connector is installed in this image.",
        "conn.enabled": "Enabled",
        "conn.enabled_on": "Connector enabled",
        "conn.enabled_off": "Connector disabled",
        "conn.save": "Save",
        "conn.saved": "Configuration saved",
        "conn.run_now": "Import now",
        "conn.running": "Import running…",
        "conn.interval": "Automatic import every {h} h.",
        "conn.last_run": "Last import",
        "conn.never_run": "never run",
        "conn.failed": "Import failed",
        "conn.summary": "{hosts} host(s), {findings} finding(s), {closed} closed",
        "conn.secret_set": "stored — leave empty to keep",
        "conn.secret_empty": "not set",
        "conn.none_configured": "No connector yet. Add one to import an external inventory.",
        "conn.add": "Add a connector",
        "conn.type": "Connector type",
        "conn.configure": "Configure",
        "conn.delete": "Delete",
        "conn.not_configured": "Not configured",
        "fdx.machine": "Machine",
        "fdx.machines": "Exposed machines ({n})",
        "fdx.console": "Defender console",
        "fdx.open_machine": "Open the machine",
        "fdx.open_cve": "View the CVE",
        "fdx.open_reco": "Open the recommendation",
        "conn.ok": "OK",
        "conn.disabled": "Disabled",
        "conn.instance_label": "Instance name",
        "conn.instance_ph": "e.g. ACME tenant",
        "conn.create": "Create",
        "conn.instance_created": "Instance created — configure its credentials",
        "conn.delete_instance": "Delete this instance",
        "conn.delete_confirm": "Delete \u00ab {label} \u00bb? Its configuration is removed; its findings are kept.",
        "conn.instance_deleted": "Instance deleted",
        ...
        "help.methodo_html": '<h1 class="heading-blue">Surface — Attack Surface Management</h1>' +
            ...
            '</ul>',
        "help.usage_html": '<h1 class="heading-blue">Using Surface</h1>' +
        ...
        "status.closed_upstream": "Closed upstream",
        "status.closed_upstream_help": "The upstream source (connector) no longer reports this finding: fixed, or excepted on its side.",
        "status.derogated": "Under derogation",
        "measures.new_title": "New corrective measure",
        "status.derogated_help": "An approved derogation covers this finding: it stays silent until it expires or is revoked.",
        "status.fixed": "Fixed",

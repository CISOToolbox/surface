...
(function () {
    ...
    window.SurfaceAPI = {
        ...
        put: function (url, body) { return _fetch(url.replace(/^\/api/, ""), { method: "PUT", body: body }); },
        ...
        addExclusion: function (data) { return _fetch("/monitored-assets/exclusions", { method: "POST", body: data }); },

if (typeof _registerTranslations === "function") {
    _registerTranslations("fr", {
        ...
        "conn.intro": "Sources externes qui importent des vulnérabilités à l'échelle du parc. Un constat qui disparaît de la source est fermé automatiquement dans Surface.",
        "conn.none_installed": "Aucun connecteur n'est installé dans cette image.",
        "conn.enabled": "Activé",
        "conn.enabled_on": "Connecteur activé",
        "conn.enabled_off": "Connecteur désactivé",
        "conn.save": "Enregistrer",
        "conn.saved": "Configuration enregistrée",
        "conn.run_now": "Importer maintenant",
        "conn.running": "Import en cours…",
        "conn.interval": "Import automatique toutes les {h} h.",
        "conn.last_run": "Dernier import",
        "conn.never_run": "jamais exécuté",
        "conn.failed": "Échec de l'import",
        "conn.summary": "{hosts} hôte(s), {findings} constat(s), {closed} fermé(s)",
        "conn.secret_set": "enregistré — laisser vide pour conserver",
        "conn.secret_empty": "non renseigné",
        "conn.none_configured": "Aucun connecteur pour l'instant. Ajoutez-en un pour importer un inventaire externe.",
        "conn.add": "Ajouter un connecteur",
        "conn.type": "Type de connecteur",
        "conn.configure": "Configurer",
        "conn.delete": "Supprimer",
        "conn.not_configured": "Non configur\u00e9",
        "fdx.machine": "Machine",
        "fdx.machines": "Machines expos\u00e9es ({n})",
        "fdx.console": "Console Defender",
        "fdx.open_machine": "Ouvrir la machine",
        "fdx.open_cve": "Voir la CVE",
        "fdx.open_reco": "Ouvrir la recommandation",
        "conn.ok": "OK",
        "conn.disabled": "D\u00e9sactiv\u00e9",
        "conn.instance_label": "Nom de l'instance",
        "conn.instance_ph": "ex. tenant ACME",
        "conn.create": "Cr\u00e9er",
        "conn.instance_created": "Instance cr\u00e9\u00e9e \u2014 configurez ses identifiants",
        "conn.delete_instance": "Supprimer cette instance",
        "conn.delete_confirm": "Supprimer \u00ab {label} \u00bb ? Sa configuration est retir\u00e9e ; ses constats sont conserv\u00e9s.",
        "conn.instance_deleted": "Instance supprim\u00e9e",
        ...
        "help.methodo_html": '<h1 class="heading-blue">Surface — Attack Surface Management</h1>' +
        ...
        "status.closed_upstream": "Fermé en amont",
        "status.closed_upstream_help": "La source amont (connecteur) ne remonte plus ce constat : corrigé, ou écarté de son côté.",
        "status.derogated": "Sous dérogation",
        "measures.new_title": "Nouvelle mesure corrective",
        "status.derogated_help": "Une dérogation approuvée couvre ce constat : il est mis en sommeil jusqu'à son expiration ou sa révocation.",

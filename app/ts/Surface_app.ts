...
function _ensureJobModal() {
    ...
    if (!ov) {
        ...
        var _md: EventTarget | null = null; ov.addEventListener("mousedown", function(e) { _md = e.target; }); ov.addEventListener("click", function(e) { if (e.target === ov && _md === ov) _closeJobModal(); });
    }
...
window._newJobDialog = function() {
    ...
    (document.getElementById("job-target") as HTMLInputElement).value = "";
    (document.querySelector('input[name="job-profile"][value="quick"]') as HTMLInputElement).checked = true;
...
window._pickMonitoredTarget = function(val) {
    if (val) (document.getElementById("job-target") as HTMLInputElement).value = val;
};

window._launchJob = function() {
    var target = (document.getElementById("job-target") as HTMLInputElement).value.trim();
    var profile = ((document.querySelector('input[name="job-profile"]:checked') || {}) as HTMLInputElement).value || "quick";

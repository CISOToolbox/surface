...
/** _fetch options: a restricted RequestInit, JSON object body tolerated. */
...
// the typing is carried by SurfaceAPIShape (Surface_types.d.ts).
...
window.SurfaceAPI = {
    ...
    listConnectors: function() { return _fetch("/connectors"); },
    listConnectorTypes: function() { return _fetch("/connectors/types"); },
    saveConnector: function(name, data) { return _fetch("/connectors/" + encodeURIComponent(name), { method: "PUT", body: data }); },
    runConnector: function(name) { return _fetch("/connectors/" + encodeURIComponent(name) + "/run", { method: "POST" }); },
    createConnectorInstance: function(ctype, label) { return _fetch("/connectors/" + encodeURIComponent(ctype) + "/instances", { method: "POST", body: { label: label } }); },
    deleteConnectorInstance: function(name) { return _fetch("/connectors/" + encodeURIComponent(name), { method: "DELETE" }); },
    ...
    createMeasure: function(data) { return _fetch("/measures", { method: "POST", body: data as Record<string, unknown> }); },
